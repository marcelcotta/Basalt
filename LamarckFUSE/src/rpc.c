/*
 * LamarckFUSE — ONC RPC message framing (RFC 5531)
 *
 * Adapted from DarwinFUSE: replaced <arpa/inet.h> and darwinfuse_internal.h
 * with LamarckFUSE equivalents. Logic is identical.
 *
...
#include "rpc.h"
#include "lamarckfuse_internal.h"  /* constants (NFS_V4, RPC_*, AUTH_*, etc.) */
#include <string.h>
