/*
 * LamarckFUSE — NFSv4 COMPOUND operation dispatcher and handlers
 *
 * Adapted from DarwinFUSE: uses lamarckfuse_internal.h.
 * All constants and structures are identical.
 *
 * Copyright (c) 2025 Basalt contributors. All rights reserved.
 * Licensed under the MIT License.
 */

#ifndef LAMARCKFUSE_NFS4_OPS_H
#define LAMARCKFUSE_NFS4_OPS_H
...
/* ---- NFSv4 operation numbers (RFC 7530 ss16) ---- */
...
/* ---- NFSv4 status codes (RFC 7530 ss13) ---- */
...
/* ---- NFSv4 file types (RFC 7530 ss4.2.3) ---- */
...
/* ---- NFSv4 attribute bit positions (RFC 7530 ss5) ---- */
...
typedef struct {
    ...
    uint32_t       open_fh_ids[MAX_OPEN_STATEIDS];
